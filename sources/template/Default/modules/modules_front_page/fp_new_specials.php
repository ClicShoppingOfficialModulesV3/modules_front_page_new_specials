...
// Template define
            ...
            if (MODULE_FRONT_PAGE_SPECIALS_PRODUCTS_FRONT_TITLE == 'True') {
              $new_prods_content .= '<div class="page-header ModuleFrontPageSpecialsHeading"><h2>' . sprintf(CLICSHOPPING::getDef('module_front_page_specials_products_heading_title') , strftime('%B')) . '</h2></div>';
            }
